...
public class ClientPL {
        ...
        while (ClientFound == false) {
            try {
                ...
                for (User userItem : UserList) {
                    if (strClientUser.matches(userItem.getUser_Name())
                            && strClientPass.matches(userItem.getUser_Password())) {
    ...
    public void ClientMenu() throws ParseException, IOException {
        ...
        while (loggedout == false) {
            ...
            System.out.println(CustomerOBJ.getCustomer_Name() + " " + CustomerOBJ.getCustomer_Surname()
                    + CustomerOBJ.getCustomer_ID());
            System.out.println("-----------------------------------------------------------------------------");
