    ...
    public void AddBooking(Customer CusOBJ) throws ParseException, IOException {
        ...
        while (dateDone == false) {
            ...
            for (Venue venueItems : AllVenueList) {
                System.out.println(
                        "Venue ID= " + venueItems.getVenue_ID() + " Venue Name= " + venueItems.getVenue_Name());
                vicount++;
            }
            ...
            System.out
                    .println("                        If Venue not on list please enter 0                           ");
            int iVenueID = 0;
            ...
            while (venueselected == false) {
                ...
                if (iVenueID > icount) {
                    ...
                    System.out.println("-----------------------------------------------------------------------------");
                    System.out
                            .println("                         Please Enter Email of Venue                          ");
            ...
            while (badults == false) {
                System.out.println("-----------------------------------------------------------------------------");
                System.out.println(
                        "                         Please Input the Amount of Adults                          ");
            ...
            while (bDecor == false) {
                System.out.println("-----------------------------------------------------------------------------");
                System.out.println(
                        "                         Would you like Decorations?(yes/no)                         ");
